...
export default function App() {
  ...
  const [addresses, setAddresses] = useState([
    { id: 1, label: 'Rumah', detail: 'Jl. Gourmet No. 123, Kota Kuliner', isMain: true }
  ]);
...
function HomeScreen({ address, addresses, setAddresses, customerName, customerPhone, customerEmail, onCheckout, onSelectItem, hasActiveOrder, initialTab = 'home', onAddressChange, onViewStatus, cart, onLogout, userRole, onOpenOwnerDashboard }: { address: string, addresses: any[], setAddresses: React.Dispatch<React.SetStateAction<any[]>>, customerName: string, customerPhone: string, customerEmail: string, onCheckout: () => void, onSelectItem: (item: any) => void, hasActiveOrder: boolean, initialTab?: string, onAddressChange: (addr: string) => void, onViewStatus?: () => void, cart?: any, onLogout?: () => void, userRole?: 'guest' | 'customer' | 'owner', onOpenOwnerDashboard?: () => void }) {
...
function CheckoutScreen({ address, cart, onBack, onOrderPlaced }: { address: string, cart: CartItem | null, onBack: () => void, onOrderPlaced: () => void }) {
